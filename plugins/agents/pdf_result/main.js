...
doc.roundedRect(table3Width + table4width + 120 + doc.widthOfString('a'.repeat(20)),
  doc.page.height / 2 - 30, 5, doc.page.height / 2 - 30).fill('#e4e4e4');
...
const containerOption = {
  align: 'center',
  width: doc.page.width - table3Width - table4width - 170 - doc.widthOfString('a'.repeat(20)),
}

generateGiftVoucher(doc, containerOption);

doc.font(boldText).text('inlaserworld.com', doc.x,doc.page.height - 170, containerOption)
doc.moveUp();
doc.moveUp();
doc.moveUp();
